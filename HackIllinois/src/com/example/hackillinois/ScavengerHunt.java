...
public class ScavengerHunt {
	...
	public ScavengerHunt(String textfile) {
		...
		this.beginDate = new Date(Integer.parseInt(begin[0]),
				Integer.parseInt(begin[1]), Integer.parseInt(begin[2]),
				Integer.parseInt(begin[3]), Integer.parseInt(begin[4]));
		String[] end = text[2].split(":");
		this.endDate = new Date(Integer.parseInt(end[0]),
				Integer.parseInt(end[1]), Integer.parseInt(end[2]),
				Integer.parseInt(end[3]), Integer.parseInt(end[4]));
