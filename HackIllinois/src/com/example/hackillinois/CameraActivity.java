...
public class CameraActivity extends Activity implements SensorEventListener {
	...
	public void onCreate(Bundle savedInstanceState) {
    	...
    	places.add(new Place("Siebel Center", false, new LatLng(40.113678, -88.224868),
    			"", ""));
    	places.add(new Place("DCL", false, new LatLng(40.113028, -88.225880),
    			"", ""));
...
/*
    	...
    	TextView label = (TextView) findViewById(R.id.targetName);
	...
	public void onSensorChanged(SensorEvent event) {
		...
		if (success) {
			...
			float angle = (float) Calculations.getAngle(pitch,
